...
plt.plot( x_dGamma, y_dGamma, label = 'discriminative gamma', marker ='^', markersize = 10)
plt.plot( x_dDelta, y_dDelta, label = 'discriminative delta', marker ='P', markersize = 10)

'''plt.plot(x_gAlpha, y_gAlpha, label = 'generative alpha', marker= 'o', markersize= 10)
plt.plot( x_gBeta, y_gBeta, label = 'generative beta', marker = 's', markersize= 15)
...
plt.title("Training Phase 2: Discriminative Learning Per Category")
plt.savefig('C:/Users/apers/Downloads/GloblocData/Train2/train2_Discr_graph_PerCat.png')
