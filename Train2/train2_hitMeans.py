...
means_df1.to_csv( "C:/Users/apers/Downloads/GloblocData/Train2/discr_phase2_means.csv", index=True, encoding='utf-8-sig')
...
print(means_df2)
means_df2.to_csv( "C:/Users/apers/Downloads/GloblocData/Train2/gener_phase2_means.csv", index=True, encoding='utf-8-sig')
