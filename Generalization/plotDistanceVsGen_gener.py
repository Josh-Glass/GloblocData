...
df_Gens = pd.read_csv('C:/Users/apers/Downloads/GloblocData/Generalization/gener_TestPhase_means.csv')
...
plt.title("Generalization Behavior with Respect to Stimuli\nDistance from Origin (Generative)")
plt.savefig('C:/Users/apers/Downloads/GloblocData/Generalization/plot_GenPerf_vs_distance_gener.png')
