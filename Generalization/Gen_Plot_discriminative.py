...
df = pd.read_csv('C:/Users/apers/Downloads/GloblocData/Generalization/discr_TestPhase_means.csv')
...
plt.xlabel("Shading")
plt.ylabel("Size")
plt.title("Discriminative: Average Generalization Response")
plt.savefig('C:/Users/apers/Downloads/GloblocData/Generalization/Gen_Plot_discriminative.png')