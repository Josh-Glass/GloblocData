...
df1 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB1_Descriptives.csv")
x_blueB1 = np.array(df1['block_data'])
y_blueB1 = np.array(df1['adj_mean'])
yerr_blueB1 = np.array(df1['stnd_error'], df1['stnd_error'])

df2 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB2_Descriptives.csv")
x_blueB2 = np.array(df2['block_data'])
y_blueB2 = np.array(df2['adj_mean'])
yerr_blueB2 = np.array(df2['stnd_error'], df2['stnd_error'])

df3 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB3_Descriptives.csv")
x_blueB3 = np.array(df3['block_data'])
y_blueB3 = np.array(df3['adj_mean'])
yerr_blueB3 = np.array(df3['stnd_error'], df3['stnd_error'])

df4 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB4_Descriptives.csv")
x_blueB4 = np.array(df4['block_data'])
y_blueB4 = np.array(df4['adj_mean'])
yerr_blueB4 = np.array(df4['stnd_error'], df4['stnd_error'])

df5 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB5_Descriptives.csv")
x_blueB5 = np.array(df5['block_data'])
y_blueB5 = np.array(df5['adj_mean'])
yerr_blueB5 = np.array(df5['stnd_error'], df5['stnd_error'])

df6 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_blueB6_Descriptives.csv")
x_blueB6 = np.array(df6['block_data'])
y_blueB6 = np.array(df6['adj_mean'])
yerr_blueB6 = np.array(df6['stnd_error'], df6['stnd_error'])

df7 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA1_Descriptives.csv")
x_redA1 = np.array(df7['block_data'])
y_redA1 = np.array(df7['adj_mean'])
yerr_redA1 = np.array(df7['stnd_error'], df7['stnd_error'])

df8 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA2_Descriptives.csv")
x_redA2 = np.array(df8['block_data'])
y_redA2 = np.array(df8['adj_mean'])
yerr_redA2 = np.array(df8['stnd_error'], df8['stnd_error'])

df9 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA3_Descriptives.csv")
x_redA3 = np.array(df9['block_data'])
y_redA3 = np.array(df9['adj_mean'])
yerr_redA3 = np.array(df9['stnd_error'], df9['stnd_error'])

df10 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA4_Descriptives.csv")
x_redA4 = np.array(df10['block_data'])
y_redA4 = np.array(df10['adj_mean'])
yerr_redA4 = np.array(df10['stnd_error'], df10['stnd_error'])

df11 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA5_Descriptives.csv")
x_redA5 = np.array(df11['block_data'])
y_redA5 = np.array(df11['adj_mean'])
yerr_redA5 = np.array(df11['stnd_error'], df11['stnd_error'])

df12 = pd.read_csv("C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/gener_Train1_redA6_Descriptives.csv")
...
plt.title("Training Phase 1: Generative Learning Per Stimulus")
plt.savefig('C:/Users/apers/Downloads/GloblocData/CheckSSL_effects/train1_Gener_graph_PerStim.png')
