...
means_df1.to_csv( "C:/Users/apers/Downloads/GloblocData/Train1/discr_phase1_means_PER_CAT.csv", index=True, encoding='utf-8-sig')
...
print(means_df2)
means_df2.to_csv( "C:/Users/apers/Downloads/GloblocData/Train1/gener_phase1_means_PER_CAT.csv", index=True, encoding='utf-8-sig')
