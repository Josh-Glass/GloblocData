...
means_df1 = df1.groupby(['block_data'], as_index= True)['hit'].describe()

print(means_df1)

means_df1.to_csv( "C:/Users/apers/Downloads/GloblocData/Train1/discr_phase1_means.csv", index=True, encoding='utf-8-sig')


df2 = df2.drop(index = df2[df2['phase_id'] == 'test_phase'].index)
df2 = df2.drop(index = df2[df2['phase_id']== 'training_phase_2'].index)

means_df2 = df2.groupby(['block_data'], as_index= True)['hit'].describe()

print(means_df2)
means_df2.to_csv( "C:/Users/apers/Downloads/GloblocData/Train1/gener_phase1_means.csv", index=True, encoding='utf-8-sig')
